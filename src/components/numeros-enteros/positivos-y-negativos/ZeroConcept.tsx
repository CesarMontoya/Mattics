    ...
    return (
        <div className="space-y-8">
            <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-slate-100 dark:bg-slate-800/10 rounded-bl-[100px] -z-10" />

                <h2 className="text-2xl font-bold text-slate-800 dark:text-zinc-100 mb-4">
                    Todo se cancela: El número Cero
                </h2>
                <p className="text-lg text-slate-600 dark:text-zinc-400 max-w-2xl">
                    Cuando tenemos la misma cantidad de fichas positivas y negativas, TODAS se cancelan. Al no quedar ninguna ficha, el resultado es <strong>cero (0)</strong>.
                </p>
                ...
                <div className="mt-8 bg-slate-50 dark:bg-zinc-800/50 p-6 rounded-2xl flex flex-col md:flex-row items-center gap-8">
                    <div className="w-full md:w-1/2 flex flex-col items-center gap-4">
                        <button
                            ...
                            className="text-sm font-semibold text-slate-600 dark:text-slate-400 flex items-center gap-2 hover:opacity-80 transition-opacity"
                        >
                        ...
                        <svg viewBox="0 0 300 200" className="w-full max-w-[250px] drop-shadow-md">
                            ...
                            <g>
                                <g className={`transition-all duration-1000 ${animated ? 'delay-1000 opacity-0' : 'opacity-100'}`}>
                                    <rect x="65" y="65" width="30" height="30" rx="8" fill="#e0e7ff" stroke="#818cf8" strokeWidth="2" />
                                    <path d="M80 73 v14 M73 80 h14" stroke="#4f46e5" strokeWidth="3" strokeLinecap="round" />
                                </g>
                                <g className={`transition-all duration-1000 ${animated ? 'delay-1000 opacity-0' : 'opacity-100'}`}>
                                    <rect x="65" y="110" width="30" height="30" rx="8" fill="#e0e7ff" stroke="#818cf8" strokeWidth="2" />
                                    <path d="M80 118 v14 M73 125 h14" stroke="#4f46e5" strokeWidth="3" strokeLinecap="round" />
                                </g>
                            </g>

                            {/* Negative Tiles */}
                            <g>
                                <g className={`transition-all duration-1000 ease-in-out ${animated ? 'translate-x-[-50px] delay-1000 opacity-0' : ''}`}>
                                    <rect x="115" y="65" width="30" height="30" rx="8" fill="#fee2e2" stroke="#f87171" strokeWidth="2" />
                                    <path d="M123 80 h14" stroke="#e11d48" strokeWidth="3" strokeLinecap="round" />
                                </g>
                                <g className={`transition-all duration-1000 ease-in-out ${animated ? 'translate-x-[-50px] delay-1000 opacity-0' : ''}`}>
                                    <rect x="115" y="110" width="30" height="30" rx="8" fill="#fee2e2" stroke="#f87171" strokeWidth="2" />
                                    <path d="M123 125 h14" stroke="#e11d48" strokeWidth="3" strokeLinecap="round" />
                                </g>
                            </g>
                            ...
                            <g className={`transition-all duration-1000 delay-[2000ms] ${animated ? 'opacity-100' : 'opacity-0'}`}>
                                ...
                                <text x="220" y="108" fontSize="24" fontWeight="bold" fill="#334155" className="dark:fill-slate-200">0</text>
                            </g>
                        </svg>
                    </div>

                    <div className="w-full md:w-1/2 space-y-4">
                        <div className="bg-slate-100 dark:bg-slate-800/30 p-4 rounded-xl text-slate-800 dark:text-slate-300">
                            <strong>Explicación:</strong> Tenemos 2 fichas positivas y 2 fichas negativas. Cada par se cancela entre sí. Al final no nos sobra ninguna ficha, es decir, el valor total es <strong>0</strong>.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col items-center">
                        ...
                        {[-1, 0, 1, 8].map(num => (
                            <button
                                ...
                                className={`w-12 h-12 rounded-xl text-lg font-bold transition-all ${exercise1Answer === num 
                                    ? num === 0 ? 'bg-emerald-500 text-white shadow-lg' : 'bg-red-500 text-white' 
                    ...
                    {exercise1Answer === 0 && (
                        <div className="text-emerald-600 dark:text-emerald-400 text-sm font-semibold mt-4 animate-in fade-in slide-in-from-bottom-2">
                            ¡Exacto! Hay la misma cantidad, por lo que da 0.
                        </div>
                    )}
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col items-center">
                    <h3 className="font-semibold text-slate-700 dark:text-zinc-200 mb-4 self-start">
                        2. Coloca fichas para que el total sea cero.
                    </h3>
                    <div className="flex gap-4 items-center flex-col w-full">
                        ...
                        {(exercise2PosTiles === exercise2NegTiles) && (exercise2PosTiles > 0) && (
                            <div className="text-emerald-600 dark:text-emerald-400 text-sm font-semibold mt-4 animate-in fade-in slide-in-from-bottom-2 text-center">
                                ¡Genial! Has igualado las cantidades y el valor se anuló. ¡Es un cero perfecto!
                            </div>
                        )}
                    </div>
                </div>
